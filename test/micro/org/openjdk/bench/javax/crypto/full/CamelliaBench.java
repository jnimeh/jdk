...
public class CamelliaBench extends CryptoBase {

    public static final int SET_SIZE = 128;

    @Param({"Camellia/ECB/NoPadding", "Camellia/ECB/PKCS5Padding", "Camellia/CBC/NoPadding", "Camellia/CBC/PKCS5Padding"})
    ...
    public void setup() throws GeneralSecurityException {
        ...
        SecretKeySpec ks = new SecretKeySpec(keystring, "Camellia");
