...
/**
 * This class implements the Camellia KeyWrap algorithm as defined
 * in <a href=http://tools.ietf.org/html/rfc3657>
 * "RFC 3657: Use of the Camellia Encryption Algorithm in Cryptographic
 * Message Syntax (CMS)" section 3 "Key Wrap Algorithm".
 * Note: only <code>ECB</code> mode and <code>NoPadding</code> padding
 * can be used for this algorithm.
 *
 * @see CamelliaCipher
 */
abstract class CamelliaWrapCipher extends CipherSpi {
    public static final class General extends CamelliaWrapCipher {
        public General() {
            super(-1);
        }
    }
    public static final class Camellia128 extends CamelliaWrapCipher {
        public Camellia128() {
            super(16);
        }
    }
    public static final class Camellia192 extends CamelliaWrapCipher {
        public Camellia192() {
            super(24);
        }
    }
    public static final class Camellia256 extends CamelliaWrapCipher {
        public Camellia256() {
            super(32);
        }
    }
    ...
    private static final int blksize = CamelliaCrypt.CAMELLIA_BLOCK_SIZE;

    /*
     * internal cipher object which does the real work.
     */
    private final CamelliaCrypt cipher;
    ...
    /**
     * Creates an instance of Camellia KeyWrap cipher with default
     * mode, i.e. "ECB" and padding scheme, i.e. "NoPadding".
     */
    public CamelliaWrapCipher(int keySize) {
        cipher = new CamelliaCrypt();
    ...
    protected void engineInit(int opmode, Key key, SecureRandom random)
        ...
        CamelliaCipher.checkKeySize(key, fixedKeySize);
        ...
        if (keyVal.length == 8) {
            ...
            for (int j = 0; j < 6; j++) {
                for (int i = 1; i <= N; i++) {
                    ...
                    System.arraycopy(buffer, 8, out, i * 8, 8);
                }
            }
        }
        return out;
