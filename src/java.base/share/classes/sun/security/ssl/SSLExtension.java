...
enum SSLExtension implements SSLStringizer {
    ...
    SH_SIGNED_CERT_TIMESTAMP    (0x0012, "signed_certificate_timestamp",
                    SSLHandshake.SERVER_HELLO,
                    ProtocolVersion.PROTOCOLS_TO_12,
                    ...
                    null,
                    SignedCertTimestampExtension.signedCertTimestampStringizer),
    CT_SIGNED_CERT_TIMESTAMP    (0x0012, "signed_certificate_timestamp",
                    SSLHandshake.CERTIFICATE,
                    ProtocolVersion.PROTOCOLS_OF_13,
                    ...
                    null,
                    SignedCertTimestampExtension.signedCertTimestampStringizer),
    CR_SIGNED_CERT_TIMESTAMP (0x0012, "signed_certificate_timestamp",
